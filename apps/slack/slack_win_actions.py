...
class UserActions:
    def messaging_workspace_previous():  actions.key('ctrl-shift-tab')
    def messaging_workspace_next():      actions.key('ctrl-tab')
    ...
    # Files and Snippets
    def messaging_upload_file():         actions.key('ctrl-u')
