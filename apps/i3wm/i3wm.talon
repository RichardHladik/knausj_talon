...
shuffle <number_small> follow:  user.system_command("i3-msg move container to workspace {number_small}; i3-msg workspace {number_small}")
shuffle ten: user.system_command("i3-msg move container to workspace 10")
shuffle screen: user.system_command("i3-msg move workspace to output right")
...
screen flip: user.system_command("i3-msg focus output right")

term me|kitty: user.i3wm_shell()
rocket: key(super-backspace)
